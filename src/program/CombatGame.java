...
class Soldier {
    ...
    public void shootMultiple(int count) {
...
public class CombatGame {
    ...
    public static void main(String[] args) {
        ...
        john.switchGuns(sniper);
        john.shootMultiple(6); // magazing runs out of bullets
        john.reloadGun();
        john.shootMultiple(6); // no bullets, can't fire the sniper again
        john.dropGun(sniper);
        
        john.pickGun(ak47); // can't pick ak47, because it's already picked by john
        john.pickGun(pistol);
        
        john.dropGun(sniper); // haven't a sniper to drop
        john.dropGun(ak47);
        john.dropGun(pistol);
        
        john.shoot(); // john haven't any gun to shoot
        
        ghost.shoot(); // ghost haven't any gun to shoot
        ghost.pickGun(ak47);
        ghost.shoot(); 
